...
{
    public partial class AddSpBeginningBalance : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"CREATE PROCEDURE [dbo].[sp_update_stock_mutation_from_bb]
	@code varchar(17),
	@date date
AS
SET NOCOUNT ON
...
END CATCH";
        ...
        {
            var sql = @"DROP PROCEDURE [dbo].[sp_update_stock_mutation_from_bb]";
            migrationBuilder.Sql(sql);
