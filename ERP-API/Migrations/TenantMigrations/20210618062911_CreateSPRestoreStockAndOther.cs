...
{
    public partial class CreateSPRestoreStockAndOther : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var sql = @"CREATE PROCEDURE [dbo].[sp_restore_stock_mutation_from_adj]
	@code varchar(17),
	@date date
AS
SET NOCOUNT ON
...
END CATCH";
        ...
        {
            var sql = @"DROP PROCEDURE [dbo].[sp_restore_stock_mutation_from_adj]";
            migrationBuilder.Sql(sql);
