...
namespace ERP.Web.API.Domain.Interfaces.Mobile.TransferStock
{
    ...
    {
        IEnumerable<MobileTransferStockHeaderModel> getTranferStockHeader(DateTime? date,string search);
        IEnumerable<MobileTransferStockDetailModel> getTransferStockDetail(string code);
        IEnumerable<MobileTransferStockHeaderModel> getMobileTranferStockHeader(DateTime? date,string search);
