...
public class PurchaseOrderController : ControllerBase
{
    ...
    public PurchaseOrderController(IPurchaseOrderService po, IUnitOfMeasurementService uom,
        IClosingMonthService closingMonth, ISystemParameterService sysPar, IActiveTransactionService activeTrans,
    ...
    private (bool, string) Validate(PurchaseOrderRequest data, bool onDelete = false, bool checkSeenByOther = true)
    {
        ...
        if (checkSeenByOther && !_activeTrans.SeenByOthers("PO", data.Code, _claim.UserId))
        {
